...
if (localStorage.getItem("settingsWHBalancerSophie") != null) {
    ...
    settings.maxDistance = (tempArray.maxDistance !== undefined) ? parseInt(tempArray.maxDistance) : 0;
...
<tr>
    ...
    <td style="padding: 6px;">
        <input type="range" min="0" max="500" step="1" value="${settings.maxDistance}" class="slider" name="maxDistance" oninput="sliderChange('maxDistance',this.value)">
        <output id="maxDistance"></output> units
    </td>
</tr>
...
function saveSettings() {
    ...
    settings.maxDistance = parseInt($("input[name='maxDistance']").val());
    localStorage.setItem("settingsWHBalancerSophie", JSON.stringify(settings));
